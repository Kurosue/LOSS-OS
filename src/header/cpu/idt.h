 ...
 * @param seg_present Segment Present Flag, big length: 1
 ...
 * More details at https://wiki.osdev.org/Interrupts_Tutorial
 * 
 * @param table Fixed-width array of SegmentDescriptor with size IDT_MAX_ENTRY_COUNT
 */
