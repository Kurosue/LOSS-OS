...
user-shell:
	...
	@$(LINKER) -T $(SRC_DIR)/user/user-linker.ld -melf_i386 --oformat=binary \
		crt0.o user-shell.o string.o cat.o cd.o ls.o mkdir.o find.o echo.o -o $(BUILD_DIR)/shell
	@echo Linking object shell object files and generate flat binary...
	@$(LINKER) -T $(SRC_DIR)/user/user-linker.ld -melf_i386 --oformat=elf32-i386 \
		crt0.o user-shell.o string.o cat.o cd.o ls.o mkdir.o find.o echo.o -o $(BUILD_DIR)/shell_elf
